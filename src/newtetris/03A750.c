...
void func_800744D0(u8 *arg0, void *arg1, u32 arg2) {
  ...
  func_800ABFF0(arg0 + 2 + (arg2 << 2), &sp18[0], 4);
  func_800ABFF0(arg0 + 2 + ((arg2 + 1) << 2), &sp18[1], 4);
...
u32 func_800745DC(u8 *arg0, u32 arg1) {
  Dram_u sp28;
  Dram_u sp18[2];
  ...
  osWritebackDCacheAll();
  func_800ABFF0(arg0, &sp28, 2);
  func_800ABFF0(arg0 + 2 + (arg1 << 2), &sp18[0], 4);
  func_800ABFF0(arg0 + 2 + ((arg1 + 1) << 2), &sp18[1], 4);
...
void FUN_03A750_800746c0_twentyliner(u8 *arg0, void *arg1, u32 arg2) {
  ...
  func_800ABFF0(arg0 + 2 + (arg2 << 2), &sp30[0], 4);
  func_800ABFF0(arg0 + 2 + ((arg2 + 1) << 2), &sp30[1], 4);
...
u32 FUN_03A750_80074888_twelveliner(u8 *arg0, u32 arg1) {
  Dram_u sp38;
  Dram_u sp28[2];
  Dram_u sp20;
  Dram_u sp18;
  ...
  func_800ABFF0(arg0 + 2 + (arg1 << 2), &sp28[0], 4);
  func_800ABFF0(arg0 + 2 + ((arg1 + 1) << 2), &sp28[1], 4);
