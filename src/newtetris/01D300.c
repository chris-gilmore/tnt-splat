...
void FUN_01D300_800570b0_fiveliner(ImgParams *imgParams, u32 img_id) {
  ...
  imgParams->img = n64HeapAlloc(FUN_03A750_80074888_twelveliner(&D_273A00, img_id));
  FUN_03A750_800746c0_twentyliner(&D_273A00, imgParams->img, img_id);
}
...
void FUN_01D300_800571d4_twentyliner(ImgPalParams *imgPalParams, u32 img_id, u32 pal_id) {
  ...
  main_8004A34C_threeliner();
  temp_s0 = FUN_03A750_80074888_twelveliner(&D_273A00, img_id);
  temp_s1 = FUN_03A750_80074888_twelveliner(&D_273A00, pal_id);
  imgPalParams->img = n64HeapAlloc(temp_s0);
  FUN_03A750_800746c0_twentyliner(&D_273A00, imgPalParams->img, img_id);
  imgPalParams->pal = n64HeapAlloc(temp_s1);
  FUN_03A750_800746c0_twentyliner(&D_273A00, imgPalParams->pal, pal_id);
  imgPalParams->x = 0;
  imgPalParams->y = 0;
